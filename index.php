...
<html lang="en"></html>
<head>
        <title>System Admin</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3>NUTRITION CLINIC MASTER</h3></div>
            ...
            ?>
            <div class="pull-left">
            <a href="patient/index.php"><h6>Patient Login</h6></a>
            </div>
